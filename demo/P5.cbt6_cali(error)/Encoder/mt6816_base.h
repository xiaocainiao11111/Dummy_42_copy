...
{
public:
    // explicit MT6816Base(uint16_t *_quickCaliDataPtr) : quickCaliDataPtr(_quickCaliDataPtr), spiRawData(SpiRawData_t{0})
    // {
    // }
    ...
    void UpdateAngle() override; // Get current rawAngle (rad)
